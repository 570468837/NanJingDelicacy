...
public class PanelForInfo extends JPanel implements ItemListener{
	...
	public PanelForInfo(Panel p, String district){
		...
		backLabel.setFont(new Font("微软雅黑", Font.PLAIN, 20));
		this.add(backLabel);
		...
		tasteLabel.setFont(new Font("微软雅黑", Font.PLAIN, 20));
		this.add(tasteLabel);
		...
		remindLabel.setFont(new Font("微软雅黑", Font.PLAIN, 20));
		this.add(remindLabel);
		
		tastes = new JComboBox<String>(Config.tastes);
		tastes.setFont(new Font("微软雅黑", Font.PLAIN, 15));
