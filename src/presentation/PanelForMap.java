...
public class PanelForMap extends JPanel{
	...
	public PanelForMap(Panel p){
		...
		left1.setSize(100,40);
		left1.setOpaque(false);
		left1.setForeground(Color.red);
		...
		buttonleft1.addMouseListener(new mouse(buttonleft1));
		...
		buttonleft2.addMouseListener(new mouse(buttonleft2));
		...
		left3.setSize(100,40);
		left3.setOpaque(false);
		left3.setForeground(Color.red);
		...
		buttonleft3.addMouseListener(new mouse(buttonleft3));
		...
		buttonleft4.addMouseListener(new mouse(buttonleft4));
		...
		left5.setSize(100,40);
		left5.setOpaque(false);
		left5.setForeground(Color.red);
		...
		buttonleft5.addMouseListener(new mouse(buttonleft5));
		...
		buttonright1.addMouseListener(new mouse(buttonright1));
		...
		right2.setSize(100,40);
		right2.setOpaque(false);
		right2.setForeground(Color.red);
		...
		buttonright2.addMouseListener(new mouse(buttonright2));
		...
		buttonright3.addMouseListener(new mouse(buttonright3));
		...
		right4.setSize(100,40);
		right4.setOpaque(false);
		right4.setForeground(Color.red);
		...
		buttonright4.addMouseListener(new mouse(buttonright4));
		...
		buttonright5.addMouseListener(new mouse(buttonright5));
