...
public class PanelForMap extends JPanel implements MouseListener{
	JLabel NanJingMap;
	JLabel buttonleft1;
	JLabel buttonleft2;
	JLabel buttonleft3;
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getSource().equals(buttonleft1)){
